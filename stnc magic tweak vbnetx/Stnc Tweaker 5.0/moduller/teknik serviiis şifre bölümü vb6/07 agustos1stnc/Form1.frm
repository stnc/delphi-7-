...
Call savestring(HKEY_CURRENT_USER, "software\Stnc Software\", "Show Tips at Startup", Check1.Value) 'check1 olayýnýn regedite yazlýp okunmasýný saðlar
...
ShowAtStartup = getstring(HKEY_CURRENT_USER, "Software\Stnc Software\", "Show Tips at Startup") 'burasý programýn baþlangýç da görünüp görünmeyecegini kontrol eder
