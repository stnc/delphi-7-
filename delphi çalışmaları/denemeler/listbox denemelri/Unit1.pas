...
//'; // ba lýkta yaz  ListBox1.Selected:=listbox2.Items.Count;

       // sayi:=ListBox1.Items.IndexOf('Antalya');//Antalya kaçýncý satýrda
  //Form1.Caption:='Seçti iniz Eleman ' + IntToStr(sayi+1)+ ' . Sýrada';
